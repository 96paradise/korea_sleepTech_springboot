...
public class JwtProvider {
    ...
    private final long jwtEamilExpirationMs;
    ...
    public JwtProvider(
            ...
            @Value("${jwt.email-expiration-ms") long jwtEamilExpirationMs
    ) {
    ...
    public String generateEmailValidToken(String username) {
        return Jwts.builder()
                .claim("username", username)
                .setIssuedAt(new Date())
                .setExpiration(new Date(System.currentTimeMillis() + jwtEamilExpirationMs))
                .compact();
    }
